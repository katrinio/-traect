...
Check-in описывает фактически прошедшую или текущую неделю и не является планом следующей недели. В одной записи допускается не более одного основного focus.
